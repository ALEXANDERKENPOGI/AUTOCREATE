...
\033[1;32m[√] TOOL         :  FREE
\033[1;37m[√] GITHUB       :  ALEXANDERKENPOGI
\033[1;35m[√] TOOL STATUS  :  AUTO CREATE FACEBOOK
\033[1;31m[√]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
boy = ['Ali Dump', 'Rustam Dump', 'Faisal Dump', 'Afzal Dump', 'Haider Dump', 'Suleman Dump', 'Nadeem Dump', 'Nazeer Dump', 'Nazeer Dump', 'Dump Rehmani', 'Safdar Dump', 'Intzar Dump', 'Saleem Dump', 'Abdullah Dump', 'Naseer Dump', 'Muzammil Dump', 'Fiaz Dump', 'Asghar Dump', 'Shabeer Dump', 'Irfan Dump', 'Ahmad Dump', 'Arzen Dump', 'Kenshin Dump', 'Ken Dump', 'Sherwin Dump', 'Nino Dump', 'Alexander Dump', 'Kyle Dump']
girl = ['Sajida Dump', 'Ayesha Dump', 'Nabeela Dump', 'Kinza Dump', 'Arooj Dump', 'Muskan Dump', 'Ayesha Dump', 'Safina Dump', 'Nida Dump', 'Rimsha Dump', 'Ashley Dump', 'Hannah Dump', 'Eunice Dump', 'Alexa Dump', 'Scarlet Dump', 'Rose Dump', 'Cassandra Dump', 'Asher Dump', 'Love Dump', 'Samantha Dump', 'Joy Dump', 'Lizzie Dump', 'Kiana Dump', 'Kisha Dump', 'Princess Dump', 'Yassmine Dump', 'Khaira Dump', 'Kyla Dump']
ok = []
cp = []
def menu():
    os.system('clear')
    ...
    print ('\033[1;32m')
    print (47*'-')
    print ('[1] AUTO CREATE NEW IDS')
    print ('[2] FACEBOOK FOLLOW')
    print ('[0] EXIT')
    print (47*'-')
    sel = input('CHOOSE : ')
    if sel in['1', '01']:
        ...
        os.system('xdg-open https://m.facebook.com/alexanderkenpogi')
        menu()
    elif sel in ['3', '03']:
        exit()
    else:
...
class create:
    ...
    def start(self):
        ...
        print (logo4)
        print ('\033[1;36m')
        print ('[1] BOYS CRACK DIS')
        print ('[2] GIRLS CRACK DIS')
        print (47*'-')
        gen = input('CHOOSE : ')
        print (47*'-')
        if gen in ['1', '01']:
            ...
            self.gender.append('boy')
        print ('Example 1000, 2000, 5000, 10000, 999999999')
        lim = int(input('LIMIT : '))
        os.system('clear')
        print (logo4)
        ...
        for x in range(lim):
            self.loop += 1
            sys.stdout.write(f'\r {OO}[ALEXANDER💙] {OO}{self.loop}/{str(lim)} OK:{len(ok)}/CP:{len(cp)}{OO} '),
            sys.stdout.flush()
            ...
            try:
                ...
                if 'checkpoint' in getts.url:
                    ...
                    print ('\r\033[38;5;208m[ALEX-CP😒] '+cok['c_user']+' | '+passw+'\033[0;97m     ')
                        ...
                        for x in BeautifulSoup(po.text, 'html.parser').find_all('form', {'method': 'post'}):
                            if 'confirmation_event_location=cliff' in str(x):
                                ...
                                if 'checkpoint' in rex.url:
                                    ...
                                    cok = self.ses.cookies.get_dict()
                                    print ('\r\033[1;32m[ALEX-OK💛] '+cok['c_user']+' | '+passw+' | '+coki+'\033[0;97m     ')
